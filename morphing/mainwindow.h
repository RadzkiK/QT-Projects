...
public:
    ...
    ~MainWindow();
    QImage img, img2, img_tmp, img2_tmp, morphed_img;
...
private slots:
    void on_frames_slider_valueChanged(int value);

    void on_img_choice_slider_valueChanged(int value);

private:
    Ui::MainWindow *ui;
    QColor c = Qt::white;
    int x0, y0, iterat, img_choice, n, frame;
};
